...
interface Addresses {
  ...
  STAKING_DUAL_REWARDS_WMATIC_USDT_QUICKSWAP: string;
  PAIR_WMATIC_WETH_QUICKSWAP: string;
  STAKING_DUAL_REWARDS_WMATIC_WETH_QUICKSWAP: string;
  PAIR_WMATIC_QUICK_QUICKSWAP: string;
  STAKING_DUAL_REWARDS_WMATIC_QUICK_QUICKSWAP: string;
  PAIR_WMATIC_USDC_QUICKSWAP: string;
  STAKING_DUAL_REWARDS_WMATIC_USDC_QUICKSWAP: string;
  DRAGON_SYRUP_QUICKSWAP: string;
  DQUICK: string;
  PROXY_REGISTRY_OPENSEA: string;
}
...
type AddressesPerNetwork = { [network in Network]: Addresses };

const MATIC: Addresses = {
  ...
  A_USDC: "0x1a13f4ca1d028320a707d99520abfefca3998b7f",
  ...
  STAKING_DUAL_REWARDS_WMATIC_USDT_QUICKSWAP:
    "0xc0eb5d1316b835F4B584B59f922d9c87cA5053E5",
  STAKING_DUAL_REWARDS_WMATIC_WETH_QUICKSWAP:
    "0x3c1f53fed2238176419f8f897aec8791c499e3c8",
  STAKING_DUAL_REWARDS_WMATIC_USDC_QUICKSWAP:
    "0x14977e7e263ff79c4c3159f497d9551fbe769625",
  STAKING_DUAL_REWARDS_WMATIC_QUICK_QUICKSWAP:
    "0xd26e16f5a9dfb9fe32db7f6386402b8aae1a5dd7",
  PAIR_WMATIC_WETH_QUICKSWAP: "0xadbf1854e5883eb8aa7baf50705338739e558e5b",
  PAIR_WMATIC_USDC_QUICKSWAP: "0x6e7a5FAFcec6BB1e78bAE2A1F0B612012BF14827",
  PAIR_WMATIC_QUICK_QUICKSWAP: "0x019ba0325f1988213d448b3472fa1cf8d07618d7",
  PROXY_REGISTRY_OPENSEA: "0xa5409ec958C83C3f309868babACA7c86DCB077c1",
};

const EMPTY: Addresses = {
  INCENTIVES_CONTROLLER: "0x0",
  ROUTER_02_SUSHISWAP: "0x0",
  NATIVE_TOKEN_USD_PRICE_FEED: "0x0",
  A_DAI: "0x0",
  A_USDT: "0x0",
  A_USDC: "0x0",
  USDT: "0x0",
  ...
  PAIR_WMATIC_WETH_QUICKSWAP: "0x0",
  PAIR_WMATIC_USDC_QUICKSWAP: "0x0",
  PAIR_WMATIC_QUICK_QUICKSWAP: "0x0",
  STAKING_DUAL_REWARDS_WMATIC_USDT_QUICKSWAP: "0x0",
  STAKING_DUAL_REWARDS_WMATIC_WETH_QUICKSWAP: "0x0",
  STAKING_DUAL_REWARDS_WMATIC_USDC_QUICKSWAP: "0x0",
  STAKING_DUAL_REWARDS_WMATIC_QUICK_QUICKSWAP: "0x0",
  PROXY_REGISTRY_OPENSEA: "0x0",
};

const MUMBAI: Addresses = {
  ...EMPTY, // TODO: If we want to use it we should remove this line
...
export const getQuickswapStakingDualRewardsAddress = (
  ADDRESSES: Pick<
    Addresses,
    | "STAKING_DUAL_REWARDS_WMATIC_WETH_QUICKSWAP"
    | "STAKING_DUAL_REWARDS_WMATIC_QUICK_QUICKSWAP"
  ...
  const tokenPairAddresses: { [k in QuickswapVaultName]: string } = {
    [QuickswapVaultName.maticEth]:
      ADDRESSES.STAKING_DUAL_REWARDS_WMATIC_WETH_QUICKSWAP,
    [QuickswapVaultName.maticQuick]:
      ADDRESSES.STAKING_DUAL_REWARDS_WMATIC_QUICK_QUICKSWAP,
    [QuickswapVaultName.maticUsdc]:
      ADDRESSES.STAKING_DUAL_REWARDS_WMATIC_USDC_QUICKSWAP,
    [QuickswapVaultName.maticUsdt]:
      ADDRESSES.STAKING_DUAL_REWARDS_WMATIC_USDT_QUICKSWAP,
  };
