...
const {
  ...
  DEFENDER_QUICKSWAP_DEPOSIT_TOKENS_AUTOTASK_ID,
  HARVESTER_ADDRESS,
  BENEFICIARY_ADDRESS,
  HARDHAT_FORKING_URL,
...
if (
  ...
  DEFENDER_QUICKSWAP_GET_REWARD_AUTOTASK_ID === undefined ||
  DEFENDER_QUICKSWAP_DEPOSIT_TOKENS_AUTOTASK_ID === undefined ||
